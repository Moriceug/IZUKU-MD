...
global.gurl = 'https://instagram.com/morice.designz' // 
...
module.exports = {
  ...
  author:  process.env.PACK_INFO === undefined ? 'moriceug' : process.env.PACK_INFO.split(";")[0],
  auto_read_status :  process.env.AUTO_READ_STATUS === undefined ? true : process.env.AUTO_READ_STATUS,
  packname:  process.env.PACK_INFO === undefined ? 'moriceug-Md' : process.env.PACK_INFO.split(";")[1],
...
recordingpresence:  process.env.RECORDING === undefined ? true : process.env.RECORDING,	
  ...
  BRANCH: 'main', 
  ALIVE_MESSAGE:  process.env.ALIVE_MESSAGE === undefined ? 'MORICE IS ACTIVE AND READY TO DELIVER' : process.env.ALIVE_MESSAGE,
